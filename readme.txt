My project consists of 4 GameObjects, the Terrain, the Water, the Sun and the camera.
...
As I haven't been able to render different colours depending on the terrains's height, I used a Unity built-in texture for the terrain as well as the water.